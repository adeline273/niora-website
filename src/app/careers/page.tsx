...
const FAQ = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "As the company grows, we're also open to exceptional people becoming part of the founding team. For the right person, founding team equity is absolutely on the table.",
    ],
  },
  {
